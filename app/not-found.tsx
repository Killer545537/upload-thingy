            ...
            <div className='container mx-auto px-6 relative z-10'>
                ...
                >
                    ...
                    >
                        ...
                        <Button
                            className='h-12 px-6 rounded-lg font-medium group w-full sm:w-auto'
                    ...
                    <motion.div
                        animate={{ opacity: 1 }}
                        className='mt-16 grid grid-cols-3 gap-3 max-w-md mx-auto'
                        initial={{ opacity: 0 }}
                    ...
                    >
                        {[1, 2, 3].map((item, index) => (
                            <motion.div
                                animate={{ opacity: 1, y: 0 }}
                                className='bg-card border border-border rounded-xl p-4 h-20'
                                initial={{ opacity: 0, y: 20 }}
                                key={item}
                                transition={{
                                    delay: 0.7 + index * 0.1,
